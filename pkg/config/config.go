...
type ChikConfig struct {
	...
	ChikAlertsPubkey         string                 `yaml:"CHIK_ALERTS_PUBKEY,omitempty" json:"CHIK_ALERTS_PUBKEY,omitempty"`
	PrivateSSLCA             CAConfig               `yaml:"private_ssl_ca" json:"private_ssl_ca"`
	ChikSSLCA                CAConfig               `yaml:"chik_ssl_ca" json:"chik_ssl_ca"`
...
type PoolConfig struct {
	UnknownFields    map[string]any    `yaml:",inline" json:",inline"`
	XCKTargetAddress string            `yaml:"xck_target_address,omitempty" json:"xck_target_address,omitempty"`
	Logging          *LoggingConfig    `yaml:"logging" json:"logging"`
	NetworkOverrides *NetworkOverrides `yaml:"network_overrides" json:"network_overrides"`
	SelectedNetwork  *string           `yaml:"selected_network" json:"selected_network"`
}
...
type FullNodeConfig struct {
	...
	SSL                              SSLConfig         `yaml:"ssl" json:"ssl"`
	UseChikLoopPolicy                bool              `yaml:"use_chik_loop_policy" json:"use_chik_loop_policy"`
...
type WalletConfig struct {
	...
	XCKSpamAmount                  uint64            `yaml:"xck_spam_amount" json:"xck_spam_amount"`
