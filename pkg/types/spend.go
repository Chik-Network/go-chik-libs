...
// Memos is a list of strings only in the RPCs, that is converted to bytes in chik. Can't send raw bytes
// Memos Ref: https://github.com/Chik-Network/chik-blockchain/blob/main/chik/rpc/wallet_rpc_api.py#L2358
